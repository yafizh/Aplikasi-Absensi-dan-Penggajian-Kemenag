...
if (isset($_POST['submit'])) {
    ...
    if ($mysqli->query($q)) {
        echo "<script>alert('Berhasil menambah data jabatan');</script>";
                    ...
                    <div class="card card-primary">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="golongan" id="golongan" autocomplete="off" required>
                            </div>
                            <div class="form-group">
                                <label for="gaji_pokok">Gaji Pokok</label>
                                <input type="text" class="form-control" name="gaji_pokok" id="gaji_pokok" required autocomplete="off">
                            </div>
                            <div>
